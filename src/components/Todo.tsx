    ...
    return(
        <div className="flex justify-between items-center p-4 rounded-lg bg-gray500 shadow-inner border-[1px] min-h-[72px] border-gray400 w-full">
            <div className="flex gap-3 align-top">
                ...
                className="appearance-none flex items-center justify-center rounded-full m-1 w-4 h-4 border-2 border-blue border-blue-500 bg-transparent cursor-pointer checked:bg-purple checked:border-0"
                type="checkbox"
